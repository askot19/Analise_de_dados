# Seleção Time Competitivo de Pokémon (Python)
...
Para esta análise foi utilizada principalmente a biblioteca **Pandas** para a manipulação e seleção dos dados, após isso, com o auxílio da simulação, foram realizados tratamentos estatísticos a fim de se aferir qual a efetividade da equipe resultante.
